# Generated by Django 3.1.4 on 2021-03-29 22:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bp_lat', models.DecimalField(decimal_places=4, max_digits=7)),
                ('bp_long', models.DecimalField(decimal_places=4, max_digits=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stormstats.player')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stormstats.game')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stormstats.player')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('player', 'season'), name='unique_skater_season'),
        ),
        migrations.AddConstraint(
            model_name='skatergamestats',
            constraint=models.UniqueConstraint(fields=('player', 'game'), name='unique_skater_game'),
        ),
        migrations.AddConstraint(
            model_name='goalieoverallstats',
            constraint=models.UniqueConstraint(fields=('player', 'season'), name='unique_goalie_season'),
        ),
        migrations.AddConstraint(
            model_name='goaliegamestats',
            constraint=models.UniqueConstraint(fields=('player', 'game'), name='unique_goalie_game'),
        ),
    ]
